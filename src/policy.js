import { PROFILE_PRESETS, SENSITIVITY_RANK } from './constants.js';

export function createPolicy(profile = 'balanced', overrides = {}) {
...
export function isCollectorAllowed(collector, policy) {
